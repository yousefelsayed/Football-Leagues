...
final class TeamsViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        sut = LeagueTeamsViewModel(leaguesUseCase: useCase, league: League(leagueId: 123, leagueName: "BRA", leagueLogo: "logo", leagueCode: "BRA", leagueAreaName: "area", numberOfTeams: "12", numberOfGames: "123"))
    }
