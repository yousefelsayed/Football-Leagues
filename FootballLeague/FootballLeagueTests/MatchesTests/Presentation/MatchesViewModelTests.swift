...
final class MatchesViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        let team = TeamsModel(id: 123,
                              shortName: "short name",
                              crest: "url",
                              tla: "tla",
                              name: "name")
        let area = AreaModel(id: 123, name: "area", flag: "flag")
        
        let currentSeason = CurrentSeasonModel(id: 123, startDate: "start date", endDate: "end date", currentMatchday: 45)
        
        let competion = CompetitionModel(id: 12,
                                         name: "name test",
                                         code: "code", emblem: "emblem",
                                         area: area,
                                         currentSeason:currentSeason,
                                         numberOfAvailableSeasons: 33)
        let teamIModel = LeagueTeamsIModel(team, competition:competion)
        
        sut = TeamMatchesViewModel(teamMatchUseCase: useCase, team: teamIModel)
    ...
    func test_getCachedTeamMatches_Success() async throws {
        ...
        let matches = TeamMatches(matches: [TeamMatchesIModel(match: MatchesModel(id: 123,
                                                                                  score: Score(fullTime: Time(home: 2, away: 3)), matchday: 12,
                                                                                  homeTeam: Team(id: 32, crest: "crest", name: "name",
                                                                                                 shortName: "short name", tla: "tla"),
